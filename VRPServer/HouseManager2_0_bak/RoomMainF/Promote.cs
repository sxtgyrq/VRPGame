...
#warning 在路上，由于资金不够，这里没有能测到。
        ...
        private void printState(RoleInGame player, Car car, string msg)
        {
        ...
        private void setDiamondOwner(int startT, commandWithTime.diamondOwner dor)
        {
            ...
            {
                CheckAllPlayersPromoteState(dor.changeType);
            }
        }
        ...
        /// <param name="pType"></param>
        /// <returns></returns>
        private void CheckAllPlayersPromoteState(string pType)
        {
