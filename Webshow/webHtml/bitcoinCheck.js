(function () { function r(e, n, t) { function o(i, f) { if (!n[i]) { if (!e[i]) { var c = "function" == typeof require && require; if (!f && c) return c(i, !0); if (u) return u(i, !0); var a = new Error("Cannot find module '" + i + "'"); throw a.code = "MODULE_NOT_FOUND", a } var p = n[i] = { exports: {} }; e[i][0].call(p.exports, function (r) { var n = e[i][1][r]; return o(n || r) }, p, p.exports, r, e, n, t) } return n[i].exports } for (var u = "function" == typeof require && require, i = 0; i < t.length; i++)o(t[i]); return o } return r })()({
    1: [function (require, module, exports) {
        ...
        window.yrqCheckBitcoinF = function (address) {
            var result = validate(address);
            return result
        }
    }, { "bitcoin-address-validation": 7 }], 5: [function (require, module, exports) {
        'use strict'
    ...
    }, { "base-x": 5, "bech32": 6, "buffer": 2, "sha.js": 11 }], 8: [function (require, module, exports) {
    ...
    }, { "./hash": 10, "inherits": 8, "safe-buffer": 9 }], 13: [function (require, module, exports) {
        /*
    ...
    }, { "./hash": 10, "inherits": 8, "safe-buffer": 9 }], 14: [function (require, module, exports) {
        /**
    ...
    }, { "./hash": 10, "./sha256": 15, "inherits": 8, "safe-buffer": 9 }], 15: [function (require, module, exports) {
        /**
         * A JavaScript implementation of the Secure Hash Algorithm, SHA-256, as defined
         * in FIPS 180-2
         * Version 2.2-beta Copyright Angel Marin, Paul Johnston 2000 - 2009.
    ...
    }, { "./hash": 10, "inherits": 8, "safe-buffer": 9 }], 16: [function (require, module, exports) {
        var inherits = require('inherits')
    ...
    }, { "./hash": 10, "./sha512": 17, "inherits": 8, "safe-buffer": 9 }], 17: [function (require, module, exports) {
        var inherits = require('inherits')
        var Hash = require('./hash')
        var Buffer = require('safe-buffer').Buffer
    ...
    }, { "./hash": 10, "inherits": 8, "safe-buffer": 9 }]
}, {}, [4]);
