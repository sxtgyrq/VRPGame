...
//		var Geometry = function Geometry(rayParams ) {

//			THREE.LightningStrike.call(this); 
//			this.
//		};

//		Geometry.prototype = Object.create(THREE.LightningStrike.prototype);
...
//			this.color = new THREE.Color(0x802280);
//			this.size = 5;
//			this.setValues(parameters);
